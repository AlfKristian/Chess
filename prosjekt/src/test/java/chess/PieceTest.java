...
public class PieceTest {
    ...
    //All the pieces act as one of these three
    ...
    public void testSetters() {
        ...
        //Testing the same as above, only with castleMoves and not legalMoves. This is King-spesific
    ...
    public void testMove() {
        ...
        //Checking ig hasMoved is updated
        assertTrue(king.getHasMoved());

        //Throws exceptions when tried to move to illegal and noen-exicting squares
